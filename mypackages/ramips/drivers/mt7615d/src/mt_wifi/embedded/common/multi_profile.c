...
/*Local definition*/
#define FIRST_AP_2G_PROFILE_PATH    "/etc/Wireless/mt7615/mt7615e2.dat"
#define FIRST_AP_5G_PROFILE_PATH    "/etc/Wireless/mt7615/mt7615e5.dat"
#define FIRST_AP_MERGE_PROFILE_PATH "/etc/Wireless/mt7615/mt7615_dbdc.dat"
#if defined(BB_SOC) && !defined(MULTI_INF_SUPPORT)
#define FIRST_AP_5G_DEVNAME "ra0"
#define FIRST_MBSSID_5G_DEVNAME "ra"
#define FIRST_APCLI_5G_DEVNAME "apcli"
#else
